class Quiz {
  constructor() {
    this.questions = [
      ...
      {
        question:
          "Você é facilmente distraído por estímulos externos, ou mesmo pensamentos não relacionaddos?",
        example: "",
      },
      {
    ...
    this.questionsHiperat = [
      ...
      },
      {
        ...
        example:
          "Exemplo: mete-se nas conversas, jogos ou atividades; pode começar a usar as coisas de outras pessoas sem pedir ou receber permissão; para adolescentes e adultos, pode intrometer-se em ou assumir o controle sobre o que outros estão fazendo",
      },
    ];
  }
  ...
  startQuiz = (test) => {
    ...
    if (test === "tda") {
      ...
      //copia a array do construtor das perguntas de hiperatividade da class Quiz
      availableQuestions = [...this.questionsHiperat];
    }
  };
